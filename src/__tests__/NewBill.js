...
// Test class functionality 2
// describe("MyCalss", () => {
//   describe("Constructor", () => {
//     it('should handle form submit event', () => {
      
//       const mockNewBill = jest.fn();
//       jest.mock('../containers/NewBill.js', () => {
//         return jest.fn().mockImplementation(() => {
//         return {NewBill: mockNewBill};
//         });
//       });
...
//         NewBill.mockClear();
//         mockNewBill.mockClear();
//       });

     
//         // const NewBill = new NewBill();
//         expect(mockNewBill).toHaveBeenCalledTimes(1);
...
//       const mockUpdateBill = jest.fn().mockImplementation(bills)



//       const mockOnNavigate = jest.fn();
//       const mockRoutesPath = { Bills:ROUTES_PATH['Bills'] };

//       Call the handleSubmit function
//       const newbill = new NewBill ({ document, onNavigate: jest.fn(),  localStorage: {} });

//       const result = newbill.handleSubmit()      
...
//           status: 'pending',
//       };
//       expect(mockUser.email).toBe(expectedBill.email);
//       expect(screen.getByTestId("expense-name")).toEqual(expectedBill.name);
//       expect(mockUpdateBill.name).toEqual(expectedBill.name);
...
//   const result = newbill.handleSubmit(mockEvent)
...
//   global.localStorage.getItem = jest.fn().mockReturnValue(JSON.stringify({ email: 'test@email.com' }));

//   // Mock the this.store.bills().create method
...
//     test('calls preventDefault, querySelector, and getItem methods', () => {
//       handleChangeFile(mockEvent);
      
//       expect(mockEvent.preventDefault).toHaveBeenCalled();
//       expect(global.document.querySelector).toHaveBeenCalledWith('input[data-testid="file"]');
